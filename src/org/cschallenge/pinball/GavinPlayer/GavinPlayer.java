...
import org.cschallenge.pinball.samples.teamG.GavinTower;
import org.cschallenge.pinball.samples.teamM.SentryTower;
...
public class GavinPlayer implements IPlayer {
	...
	public void onDetectBall(Turn turn, TowerQueue queue, TeamType teamType,Position position) {
		...
		case FOE:
			...
			System.out.println(enemyBallPosition.distance(0, 0));
			break;
